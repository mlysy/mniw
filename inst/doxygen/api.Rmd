...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`triMultXU`](#_tri_utils_8h_1ad9c65f39981a3e4e609e16ac929bb496)`(Ref< MatrixXd > Y,const Ref< const MatrixXd > & X,const Eigen::MatrixBase< T1 > & U)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`triMultLX`](#_tri_utils_8h_1abc315a2e184858938a30ea0b796a65ea)`(Ref< MatrixXd > Y,const Eigen::MatrixBase< T1 > & L,const Ref< const MatrixXd > & X)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`triMultLiX`](#_tri_utils_8h_1a7f22604e6c692494f4772837f9b6e0c3)`(Ref< MatrixXd > X,const Eigen::MatrixBase< T1 > & L)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`triMultXLi`](#_tri_utils_8h_1adfde552c3f71d142ee6ded89e49f9fb0)`(Ref< MatrixXd > X,const Eigen::MatrixBase< T1 > & L)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`triMultUiX`](#_tri_utils_8h_1aa62489bafdc65d2645b57e480ee2572e)`(const Eigen::MatrixBase< T1 > & U,Ref< MatrixXd > X)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`crossProdUtU`](#_tri_utils_8h_1a79a58591ed0f4f3bd3c151d6d7f52266)`(const Eigen::MatrixBase< T1 > & X,const Ref< const MatrixXd > & U,const Eigen::MatrixBase< T2 > & L)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`CrossProdLLt`](#_tri_utils_8h_1a7ca9facdac5bff93d2db13420c3edf8e)`(const Eigen::MatrixBase< T1 > & X,const Ref< const MatrixXd > & L,const Eigen::MatrixBase< T2 > & U)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`CrossProdLtL`](#_tri_utils_8h_1af6693aa50f28ec42c038f8f532741332)`(const Eigen::MatrixBase< T1 > & X,const Ref< const MatrixXd > & L,const Eigen::MatrixBase< T2 > & U)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public template<>`  <br/>`void `[`InverseLLt`](#_tri_utils_8h_1aee6a1777f73c71378680d77c59814479)`(Ref< MatrixXd > X,const Eigen::MatrixBase< T1 > & L,Ref< MatrixXd > L2,Ref< MatrixXd > U,const Ref< const MatrixXd > & I)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`ReverseCholesky`](#_tri_utils_8h_1a18fc2d655dc265f4c1133403a61034fb)`(Ref< MatrixXd > L,const Ref< const MatrixXd > & V,LLT< MatrixXd > & llt)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`logDetCholV`](#_tri_utils_8h_1a3f6653dcf99e9386dde5bd02fbe099b9)`(LLT< MatrixXd > & cholV)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`logDetV`](#_tri_utils_8h_1ad13e348945b0a769632c1dd5c0c96ae2)`(MatrixXd V,LLT< MatrixXd > cholV)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`logMultiGamma`](#_wishart_8h_1a53aee90f94b4d2aa862f49332ceb68d7)`(double alpha,int q)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`~HierNormal`](#classmniw_1_1_hier_normal_1a7cdd4ca1137d61b7987da1bfde3417f7)`()`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public void `[`setMu`](#classmniw_1_1_hier_normal_1a0b982b25a9c108f589a66fae346099ef)`(const Ref< const MatrixXd > & Mu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`setISigmaL`](#classmniw_1_1_hier_normal_1a1191fec3e77190fbdc15bc440371a2b3)`(const Ref< const MatrixXd > & iSigmaL)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`setISigma`](#classmniw_1_1_hier_normal_1aa9209e19f30a24a856ca5c05acf10bc4)`(const Ref< const MatrixXd > & iSigma)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`setBeta`](#classmniw_1_1_hier_normal_1a683a17a5b1b34a44c563a656c7783d26)`(const Ref< const MatrixXd > & Beta)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`getMu`](#classmniw_1_1_hier_normal_1ab3434867e28a9f411c5cd9242258ed94)`(Ref< MatrixXd > Mu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`getMut`](#classmniw_1_1_hier_normal_1aab4999c72fcaf724af0f258698994c3e)`(Ref< MatrixXd > Mut)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`getISigmaL`](#classmniw_1_1_hier_normal_1ade02a76b6f590cc568589ec6842424c1)`(Ref< MatrixXd > iSigmaL)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`getSigma`](#classmniw_1_1_hier_normal_1a9b3c2f1a3fc2aaf58698f49332a8f1ea)`(Ref< MatrixXd > Sigma)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`getBeta`](#classmniw_1_1_hier_normal_1a2e60f51963dcd0a7d7fa5d274d69d91b)`(Ref< MatrixXd > Beta)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`UpdateBetaSigma`](#classmniw_1_1_hier_normal_1a349f4d3f8d9a1c2cdf85884a5e632fdc)`()`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`UpdateMu`](#classmniw_1_1_hier_normal_1afa4af9e8e1d5a01c30d0345db6e1e5d2)`()`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`MatrixNormal`](#classmniw_1_1_matrix_normal_1a033d7bb7ce43323157697c42e59db975)`(int p,int q)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_matrix_normal_1a6b5cd49b51f7ee90822bed404e3d630a)`(const Ref< const MatrixXd > & X,const Ref< const MatrixXd > & Lambda,const Ref< const MatrixXd > & SigmaR,const Ref< const MatrixXd > & SigmaC)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_matrix_normal_1ab38b401fdf3f08d7e60a22215c84b993)`(const Ref< const MatrixXd > & X,const Ref< const MatrixXd > & Lambda,LLT< MatrixXd > & cholSigmaR,double ldSigmaR,LLT< MatrixXd > & cholSigmaC,double ldSigmaC)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateRowSColS`](#classmniw_1_1_matrix_normal_1a4eafd57c4a23562faca523fa1bceb6a2)`(Ref< MatrixXd > X,const Ref< const MatrixXd > & Lambda,const Ref< const MatrixXd > & SigmaRL,const Ref< const MatrixXd > & SigmaCU)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateRowSColO`](#classmniw_1_1_matrix_normal_1a1c76fef69a647250464e6a3fc0c2f4f3)`(Ref< MatrixXd > X,const Ref< const MatrixXd > & Lambda,const Ref< const MatrixXd > & SigmaRL,const Ref< const MatrixXd > & OmegaCL)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateRowOColO`](#classmniw_1_1_matrix_normal_1a447f4e7fe19375f691d96cbb809625bd)`(Ref< MatrixXd > X,const Ref< const MatrixXd > & Lambda,const Ref< const MatrixXd > & OmegaRU,const Ref< const MatrixXd > & OmegaCL)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`MatrixT`](#classmniw_1_1_matrix_t_1a329612cbfc19c924e38c4eea02c7e892)`(int p,int q)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`~MatrixT`](#classmniw_1_1_matrix_t_1a73b4733f5320f96efbc05851a3ca9e97)`()`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_matrix_t_1a9100e03eec1852d1b344c316e4715253)`(const Ref< const MatrixXd > & X,const Ref< const MatrixXd > & Mu,const Ref< const MatrixXd > & SigmaR,const Ref< const MatrixXd > & SigmaC,double nu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_matrix_t_1a411e948daebd9167a8c8977fab16d710)`(const Ref< const MatrixXd > & X,const Ref< const MatrixXd > & Mu,const Ref< const MatrixXd > & SigmaR,LLT< MatrixXd > & cholSigmaR,double ldSigmaR,const Ref< const MatrixXd > & SigmaC,LLT< MatrixXd > & cholSigmaC,double ldSigmaC,double nu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateRowSColO`](#classmniw_1_1_matrix_t_1aeb87b7148aae159e618a72ecfa604dd2)`(Ref< MatrixXd > X,const Ref< const MatrixXd > & Mu,const Ref< const MatrixXd > & SigmaRL,const Ref< const MatrixXd > & OmegaCL,double nu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateRowOColO`](#classmniw_1_1_matrix_t_1a4aaaf2387d4a7fb8c1fe3ef420671f66)`(Ref< MatrixXd > X,const Ref< const MatrixXd > & Mu,const Ref< const MatrixXd > & OmegaRU,const Ref< const MatrixXd > & OmegaCL,double nu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`MultiNormal`](#classmniw_1_1_multi_normal_1a2ed4c6ad5819a215986173695a7c65bf)`(int q)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_multi_normal_1a729cdde2d7a2b1f7fe01808aff857618)`(const Ref< const VectorXd > & x,const Ref< const VectorXd > & mu,LLT< MatrixXd > & cholSigma,double ldSigma)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_multi_normal_1a5855e0c97ab0ba0058a8655971a03f5c)`(const Ref< const VectorXd > & x,const Ref< const VectorXd > & mu,const Ref< const MatrixXd > & Sigma)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`Generate`](#classmniw_1_1_multi_normal_1ad1f32eefd016026d35409d05027b7efd)`(Ref< VectorXd > x,const Ref< const VectorXd > & mu,LLT< MatrixXd > & cholSigma,Ref< MatrixXd > SigmaL)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`Generate`](#classmniw_1_1_multi_normal_1a06b212c5fc2e3798732629c7a5d7c848)`(Ref< VectorXd > x,const Ref< const VectorXd > & mu,const Ref< const MatrixXd > & Sigma)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`RanfxNormal`](#classmniw_1_1_ranfx_normal_1ade1dc31fcdea4b65ff535dae696160ba)`(int q)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateOL`](#classmniw_1_1_ranfx_normal_1a210fbf6ebb0352948ece63614a720dfe)`(Ref< VectorXd > mu,const Ref< const VectorXd > & x,const Ref< const MatrixXd > & C,const Ref< const MatrixXd > & OmegaL)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateO`](#classmniw_1_1_ranfx_normal_1aa27b8e328fd4d30eed11bd9986c7afec)`(Ref< VectorXd > mu,const Ref< const VectorXd > & x,const Ref< const MatrixXd > & C,const Ref< const MatrixXd > & Omega)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline  `[`Wishart`](#classmniw_1_1_wishart_1a45f260ee7fc79c85497a7449a2220200)`(int q)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_wishart_1ad0402256f527189c57765da8307dd413)`(const Ref< const MatrixXd > & X,const Ref< const MatrixXd > & Psi,double nu,bool inv)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline double `[`LogDens`](#classmniw_1_1_wishart_1a5f9c66bba21d482bb20760809c531f90)`(const Ref< const MatrixXd > & X,LLT< MatrixXd > & cholX,double ldX,const Ref< const MatrixXd > & Psi,LLT< MatrixXd > & cholPsi,double ldPsi,double nu,bool inv)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateLowerTri`](#classmniw_1_1_wishart_1a091d1a4ae2eaf983bbce2ffdb205d5e3)`(Ref< MatrixXd > XL,const Ref< const MatrixXd > & PsiL,double nu)`")
```
...
```{r, echo = FALSE, results = "asis"}
parse_proto("`public inline void `[`GenerateLowerTriXi`](#classmniw_1_1_wishart_1aa0409c4d479a1228b591e6ab9351bb9b)`(Ref< MatrixXd > XL,const Ref< const MatrixXd > & XiL,double nu)`")
```
